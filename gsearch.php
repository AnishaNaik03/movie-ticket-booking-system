...
<div class="upcoming" style= "background: url('image/back1.jpg')">
...
<?php 
            ...
            $query = " select DISTINCT movie_id,title,release_date,Genre,rating,duration,poster,cast1,cast2,cast3,director,trailer from movies where Genre='".$search."'";
...
?>
 <img src="image/<?php echo $info['poster'];?>">
    ...
    <a href="booking1.php?id=<?php echo $info['movie_id'];?>"><input type="submit" value="Available show"></a>       	
